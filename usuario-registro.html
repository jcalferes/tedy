                        ...
                        <div class="col-sm-12">
                            <nav class="top-header-menu">
                                <ul class="menu">
                                    ...
                                    <li class="aux-languages dropdown animate-hover" data-animate="animated fadeInUp"><a href="#"><span class="language name">Español</span></a>
                            ...
                            <div class="col-md-8">
                                <div class="w-section inverse">                       
                                    <div class="w-box sign-in-wr bg-5">
                                        ...
                                        <div class="form-body">
                                            <p>
                                                Complete el formulario y de clic en el botón registrar, se le enviara un correo electrónico con el procedimiento para completar su registro.
                                            </p>
                                            <form class="form-light padding-15">                                
                                                <div class="form-group">
                                                    <label>Email</label>
                                                    <input type="email" class="form-control" placeholder="" id="txtusuario_email">
                                                </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="password" class="form-control" placeholder="" id="txtusuario_password">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label>Confirmar password</label>
                                                            <input type="password" class="form-control" placeholder="" id="txtusuario_cpassword">
                                                        </div>
                                                    </div>
                                                </div>      
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <button class="btn btn-three pull-right" type="button" id="btnusuario_password">Registrar</button>                        
                                                    </div>
                                                </div>
                                            </form>
                                        </div>
