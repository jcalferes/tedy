                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-md-3">
                                <div class="widget">
                                    <ul class="categories">
                                        <li><a href=""><i class="fa fa-video-camera"></i> New product</a></li>
                                        <li><a href="shop-profile.html"><i class="fa fa-edit"></i> Personal data</a></li>
                                        <li><a href="shop-order-history.html"><i class="fa fa-list-ol"></i> Order history</a></li>
                                        <li><a href="shop-whishlist.html"><i class="fa fa-heart"></i>  Whishlist</a></li>       
                                    </ul>
                                </div>
                            </div>
                            <div class="col-md-9">
